      ...
      >
        <div className="container mx-auto flex justify-between items-center">
            ...
            {[
              ...
              <Link
                ...
                className={`hover:text-yellow-400 ${
                  location.pathname === link.path ? "border-b-2 border-yellow-400" : ""
                }`}
              >
                {link.name}
              </Link>
          ...
          <div className="md:hidden">
            <FiMenu size={30} className="cursor-pointer" onClick={toggleSidebar} />
          </div>
        </div>
      </motion.nav>
          ...
          <div className="flex flex-col gap-y-5">
            {[
              ...
              <Link
                ...
                to={link.path}
                className={`hover:text-yellow-400 ${
                  location.pathname === link.path ? "bg-yellow-400 text-gray-900 px-3 py-2 rounded" : ""
                }`}
              >
                {link.name}
              </Link>
